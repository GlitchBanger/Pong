...
use amethyst::{
    ...
    ecs::{Component, DenseVecStorage, World, Entity},
    prelude::*,
...
pub const BALL_VELOCITY_X: f32 = 21.0;
pub const BALL_VELOCITY_Y: f32 = 14.0;
...
//initializes the camera entity and add it to the world
